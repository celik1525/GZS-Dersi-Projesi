 ...
 * @author Ruhi ÇELİK
 */
public class tempXY extends JFrame {
   ...
   setTitle("Sıcaklık Okumaları");
    ...
    add(top,BorderLayout.NORTH);
        ...
        for (int i=0;i<portnames.length;i++){
          ...
          series=new XYSeries("Sıcaklık okumaları");
        XYSeriesCollection dataSet=new XYSeriesCollection(series);
        JFreeChart chart=ChartFactory.createXYLineChart("ISI okumalar", "Zaman(saniye)", "ADC Okumaları", dataSet);
