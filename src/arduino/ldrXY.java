 ...
 * @author Ruhi ÇELİK
 */
public class ldrXY extends JFrame{
    JButton connect;
   ...
   XYSeries series;
    ...
    setSize(600,400);
        ...
        for (int i=0;i<portnames.length;i++){
          ...
          series=new XYSeries("LDR okumaları");
        XYSeriesCollection dataSet=new XYSeriesCollection(series);
        JFreeChart chart=ChartFactory.createXYLineChart("LDR okumalar", "Zaman(saniye)", "ADC Okumaları", dataSet);
